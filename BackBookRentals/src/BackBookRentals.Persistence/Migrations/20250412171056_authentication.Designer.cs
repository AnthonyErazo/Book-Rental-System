...
namespace BackBookRentals.Persistence.Migrations
{
    ...
    [Migration("20250412171056_authentication")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackBookRentals.Entities.OrderBook", b =>
                {
                    ...
                    b.ToTable("OrderBook", "Pedidos_Libros");
                });
            ...
            modelBuilder.Entity("BackBookRentals.Entities.UserToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("UserToken", "Usuario_Token");
                });
            ...
            modelBuilder.Entity("BackBookRentals.Entities.UserToken", b =>
                {
                    b.HasOne("BackBookRentals.Entities.User", "User")
                        .WithMany("Tokens")
